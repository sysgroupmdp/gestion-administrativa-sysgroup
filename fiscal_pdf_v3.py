...
PDF_TEMPLATE_VERSION = "ARCA_TRIPLICADO_SSGROUP_V3_1"
...
def _draw_page(c: canvas.Canvas, *, copia: str, emisor: Dict[str, Any], cliente: Dict[str, Any],
    ...
    if logo:
        try:
            c.drawImage(logo, L + 8, y_top - 40, width=108, height=36,
    ...
    bx = split - 27
    # ARCA centra la caja de la letra sobre la divisoria, pero la divisoria NO atraviesa la caja.
    # La pintamos con fondo blanco para tapar el tramo de la línea vertical que queda detrás.
    c.setFillColor(colors.white)
    c.rect(bx, y_top - 47, 42, 47, fill=1, stroke=1)
